...
const cities=[{img:"https://www.docplanner.com/images/warsaw.png",cityname:"Warsaw"},
{img:"https://www.docplanner.com/images/barcelona.png", cityname:"Barcelona"},
{img:"https://www.docplanner.com/images/istanbul.png", cityname:"Istanbul"},
{img:"https://www.docplanner.com/images/rome.png", cityname:"Rome"},
{img:"https://www.docplanner.com/images/mexico-city.png", cityname:"Mexico City"},
{img:"https://www.docplanner.com/images/curitiba.png", cityname:"Curtiba"}]
const cards=[{forwho:"For patients",cardIntro:"Find a doctor, book a visit and solve any health-related doubt",citySelector:true, image:"https://www.docplanner.com/img/screen-marketplace@2x.png",style:"card"},
{forwho:"For Doctors",cardIntro:"Save time managing visits and cut no-shows by half",citySelector:false, image:"https://www.docplanner.com/img/screen-saas@2x.png",style:"card-second"}]
function App() {
  return (
    <div className="App">
      <Myheader/>
      <div className="description">
          <img className="title-logo" src="https://www.docplanner.com/img/sygnet.png" alt="logo"/>
      ...
      <div className="cards">
         {cards.map((el,i)=> <Card 
         forwho={el.forwho} 
         cardIntro={el.cardIntro} 
         citySelector={el.citySelector} 
         image={el.image}
         style={el.style}
         />)}
      </div>
      ...
      <div className="brands">
         ...
         <ul className="brands-logos">
                     ...
                     <li>
                        <a href="#" >
                           <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 195 32">
         ...
         <div className="stats-inner">
            <div className="stats-intro">
             ...
             <div className="stats-cards">
               <div className="stats-left-cards">
                   <div className="stats-card">
                       <img src="https://www.docplanner.com/img/flag.png"/>
                       <h3>Leader in 10 countries</h3>
                       <p>Poland, Turkey, Spain, Italy, <br/>Czech Republic, Mexico, Brazil, <br/> Colombia, Argentina and Chile</p>
                   </div>
                   <div className="stats-card">
       ...
       <div className="cities"> 
         { cities.map((el,i) => <City img={el.img} cityname={el.cityname} key={i} />) }
       </div>
